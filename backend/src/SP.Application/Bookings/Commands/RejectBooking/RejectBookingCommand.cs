// SP.Application/Bookings/Commands/RejectBooking/RejectBookingCommand.cs
...
namespace SP.Application.Bookings.Commands.RejectBooking;

public sealed record RejectBookingCommand(Guid BookingId, Guid ProviderId) : ICommand;
...
public sealed class RejectBookingCommandHandler : ICommandHandler<RejectBookingCommand>
{
    ...
    public RejectBookingCommandHandler(IBookingRepository bookingRepository, IUnitOfWork unitOfWork)
    {
